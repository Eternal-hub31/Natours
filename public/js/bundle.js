...
exports.showMessage = exports.RemoveMessage = void 0;
...
var showMessage = function showMessage(type, message) {
  RemoveMessage();
  var markup = "<div class=\"alert alert--".concat(type, " fade-in\">").concat(message, "</div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              ...
              (0, _alerts.showMessage)('success', 'logged out successfully');
            }
          ...
          case 7:
            ...
            (0, _alerts.showMessage)('error', 'Error logging out try again');
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              ...
              (0, _alerts.showMessage)('success', 'logged in successfully welcome back');
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showMessage)('error', 'wrong credentials. please login again');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9oYW1tZWRqYW1hbDIzNCIsImEiOiJjbDdpMXVxenMwazRlM3dzYXZrYTMxYjBvIn0.yo2Uwk79uGx2lk_IyWTVFQ';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              ...
              (0, _alerts.showMessage)('success', 'Signed up successfully');
            }
          ...
          case 8:
            ...
            (0, _alerts.showMessage)('Failed please Try again with the correct info');
...
exports.UpdatingSettings = void 0;
...
var UpdatingSettings = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status = 'success') {
              (0, _alerts.showMessage)('success', "".concat(type.toUpperCase(), " updated Successfully"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1800);
            }
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showMessage)('error', _context.t0.response.data.message);
  ...
  return function UpdatingSettings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.UpdatingSettings = UpdatingSettings;
...
/* eslint-disable */
var stripe = Stripe('pk_test_51Lf9koFSqo2Pj5Nez43nikPWmeXLStJlhYFdm3O7usa7zOolQqQge4ucer2PCFyMH7Kp0JpsrU8hM4cUlP14D1Am00x2I2VZe5'); // Call your backend to create the Checkout Session
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            _context.prev = 13;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showMessage)('error', 'something went wrong');
...
// <---! Dom Elements !--->
var Updatingform = document.querySelector('.form-user-data');
var UpdatingPasswordForm = document.querySelector('.form-user-settings');
var loginform = document.querySelector('.form--login');
var logoutbtn = document.querySelector('.nav__el--logout');
var signupform = document.querySelector('.signup-form');
var btnBookings = document.getElementById('book-tour'); // <---! Dom Elements !--->

if (Updatingform) {
  Updatingform.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log(form);
              (0, _updateSettings.UpdatingSettings)(form, 'data');
...
if (UpdatingPasswordForm) {
  UpdatingPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 7;
              return (0, _updateSettings.UpdatingSettings)({
